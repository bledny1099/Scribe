...
- **Multilingual Support**: Real-time speech recognition across 50+ languages with automatic language detection and optional English translation.
...
3. Launch **Scribe** and grant Microphone and Accessibility permissions.

#### First-Launch Note (macOS Gatekeeper)

Because Scribe is a free open-source app distributed outside the Mac App Store without a paid Apple Developer certificate, macOS may flag it on first launch:

- **Quick Fix**: Right-click (or Control-click) `Scribe.app` in `/Applications`, choose **Open**, then click **Open**.
