...
enum Localization {
    ...
    private static let translations: [String: [String: String]] = [
        ...
        "ru": [
            ...
            "Clean": "Чистый",
            "Raw (Verbatim)": "Без фильтрации (Raw)",
            "Code & Dev": "Код и разработка",
            "Chat & Messaging": "Мессенджеры и чаты",
            "Email & Formal": "Деловой и письма",
            "Smart filler removal & clean punctuation.": "Умная очистка от слов-паразитов и аккуратная пунктуация.",
            "Verbatim speech without any filtering.": "Дословная речь без фильтрации и сокращений.",
            "camelCase, snake_case, CLI flags & code syntax.": "camelCase, snake_case, CLI-флаги и синтаксис кода.",
            "Concise punctuation for Telegram & Slack.": "Лаконичная пунктуация для Telegram и Slack с эмодзи.",
            "Polished grammar for emails & documents.": "Исправление разговорных форм и структурированная речь для писем.",
            "Automatically removes verbal clutter (uh, um, эээ, ну типа, короче), fixes capitalization, and standardizes tech terminology.": "Автоматически убирает слова-паразиты (эээ, ну типа, короче, um), выравнивает регистр и стандартизирует терминологию.",
            "Preserves every spoken word exactly as uttered by the model without conversational truncation or filler stripping.": "Сохраняет каждое произнесенное слово без сокращений и без фильтрации паразитов.",
            "Transforms spoken programming constructs (e.g. 'camel case userId' → userId, 'flag force' → --force, 'dot ts' → .ts, 'const data' → const data).": "Трансформирует конструкции кода (например, «кэмел кейс user id» → userId, «флаг force» → --force, «точка ts» → .ts).",
            "Optimized for messengers: trims heavy sentence-ending periods in single-line replies and converts spoken emojis (👍, 🔥, 🚀).": "Оптимизирован для мессенджеров: убирает точку в коротких ответах и преобразует голосовые эмодзи (👍, 🔥, 🚀).",
            "Polishes colloquial speech into articulate, formal business prose with full punctuation and professional phrasing.": "Преобразует разговорные выражения в структурированный деловой стиль с выверенной пунктуацией.",
